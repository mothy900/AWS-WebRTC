...
export default class NoOpAudioVideoController extends DefaultAudioVideoController {
  constructor(configuration?: MeetingSessionConfiguration) {
    ...
    emptyConfiguration.urls.screenSharingURL = 'wss://wss-589696534.ap-northeast-2.elb.amazonaws.com/';
    emptyConfiguration.urls.signalingURL = 'wss://wss-589696534.ap-northeast-2.elb.amazonaws.com/';
    super(
